package com.km.rest.controllers;
...
import com.km.rest.services.StudentService;
...
public class StudentController {
	...
	public Course reriveDetailsForCourse(@PathVariable String studentId, @PathVariable String courseId) {
