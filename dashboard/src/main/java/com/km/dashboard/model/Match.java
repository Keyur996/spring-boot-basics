package com.km.dashboard.model;
...
public class Match {
	...
	public Match(String city, LocalDate date, String playerOfMatch, String venue, String team1, String team2,
	...
	public String toString() {
		return "Match [city=" + city + ", date=" + date + ", playerOfMatch=" + playerOfMatch + ", venue=" + venue
